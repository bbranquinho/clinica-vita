...
public class FileUploadRepositoryTest {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(FileUploadRepositoryTest.class);
	...
	public void updateTest(){
		FileUpload fileUpload = this.fileUploadRepository.findByMimeType("teste image/jpeg;base64");
		
		if(fileUpload != null){			
			fileUpload.setMimeType("teste update image/jpeg;base64");			
			LOGGER.info("Test update fileUpload"+this.fileUploadRepository.save(fileUpload));	
	...
	public void deleteTest(){
		FileUpload fileUpload = this.fileUploadRepository.findByMimeType("teste update image/jpeg;base64");	
		 LOGGER.info("fileUpload:" + fileUpload);
		if(fileUpload != null){
			 this.fileUploadRepository.delete(fileUpload);
			 LOGGER.info("Teste delete fileUpload" + fileUpload);
			 findAllTest();
		}else{
