...
CREATE TABLE `cidades` (
  ...
  `ds_cidade_nome` varchar(255) NOT NULL,
  `cd_uf` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`cd_cidade`),
  KEY `FK_5kl9ojammp53sd489dwu9if2q` (`cd_uf`),
  CONSTRAINT `FK_5kl9ojammp53sd489dwu9if2q` FOREIGN KEY (`cd_uf`) REFERENCES `uf` (`cd_uf`)
