...
CREATE TABLE `logradouros` (
  `cd_logradouro` bigint(20) NOT NULL AUTO_INCREMENT,
  `no_logradouro_cep` varchar(255) NOT NULL,
  `ds_logradouro_nome` varchar(255) NOT NULL,
  `cd_bairro` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`cd_logradouro`),
  KEY `FK_hca21dgcu6vtp7syiegbm79wv` (`cd_bairro`),
  CONSTRAINT `FK_hca21dgcu6vtp7syiegbm79wv` FOREIGN KEY (`cd_bairro`) REFERENCES `bairros` (`cd_bairro`)
