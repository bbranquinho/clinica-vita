...
function picker(){
    ...
    var daysNames = [
        {'single':'D', 'shortName':'Dom', 'fullName':'Do startDate:nday'},
        {'single':'S', 'shortName':'Seg', 'fullName':'Segunda'},
        {'single':'T', 'shortName':'Ter', 'fullName':'Terça'},
        {'single':'Q', 'shortName':'Qua', 'fullName':'Quarta'},
        {'single':'Q', 'shortName':'Qui', 'fullName':'Quinta'},
        {'single':'S', 'shortName':'Sex', 'fullName':'Sexta'},
        {'single':'S', 'shortName':'Sab', 'fullName':'Sabado'}
    ];
    ...
    var rangeCustomStartEnd =['Data Inicial', 'Data Final'];
