...
angular.module('clinica')
    .controller('EditSetorDialogController', function ($scope,$mdDialog,RestSrv,SERVICE_PATH,$mdToast, $rootScope ,_editarSetor) {
        ...
        /* $rootScope.$on('editSetorEvent', function(event, valor){


         $scope.$watch('editSetor', function(){
         //$scope.size = $scope.editSetor.length;
         $scope.editSetor = valor;
         console.log($scope.editSetor);
