...
angular.module('clinica')
    .controller('EditCargoDialogController', function ($scope,$mdToast,$mdDialog,RestSrv,SERVICE_PATH, $rootScope ,_editarCargo) {
        ...
        /* $rootScope.$on('editCargoEvent', function(event, valor){


         $scope.$watch('editCargo', function(){
         //$scope.size = $scope.editCargo.length;
         $scope.editCargo = valor;
         console.log($scope.editCargo);
