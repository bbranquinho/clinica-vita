...
angular.module('clinica',[
   ...
   /* 'mdThemeColors',
    ...
    pickerProvider.setMonthNames(["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"]);
    pickerProvider.setRangeDefaultList(['Hoje', '7 Dias Anteriores', 'Este Mês', 'Mês Anterior', 'Este Trimestre', 'Ano até a data', 'Este Ano', 'Range Customizado']);
    pickerProvider.setRangeCustomStartEnd(['Data Inicial', 'Data Final']);
    $mdThemingProvider.setDaysNames()*!/
